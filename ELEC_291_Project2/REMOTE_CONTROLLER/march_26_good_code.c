...
// ==========================================
// Timer 0 runs at SYSCLK/12 = 6MHz â†’ 1 tick = 0.167us
// Pulse width thresholds (in ticks):
//   Header burst  ~421us â†’ ~2526 ticks â†’ check 1800â€“3600
//   Zero burst    ~210us â†’ ~1260 ticks â†’ check  600â€“2100
//   One burst     ~842us â†’ ~5052 ticks â†’ check 3000â€“6600
...
char _c51_external_startup (void)
{
    ...
    // SYSCLK/12 = 6MHz, 1 tick = 0.167us â€” completely independent of Timer 2
...
//
// Falling edge â†’ burst started  â†’ record start time
// Rising edge  â†’ burst ended    â†’ measure width â†’ decode bit
...
void PortMatch_ISR(void) interrupt 8
{
    ...
    if (!(P0 & 0b_0001_0000))
    {
        ...
        P0MAT &= ~0b_0001_0000; // Now expect LOW â†’ catch rising edge next
    }
    else
    {
        // --- RISING EDGE: burst ended ---
        ir_width = current_time - ir_start_time;
        P0MAT |= 0b_0001_0000;  // Now expect HIGH â†’ catch falling edge next
